...
public class FreezerResultSlot extends Slot
{
    ...
    protected void checkTakeAchievements(ItemStack stack)
    {
        ...
        if(!this.player.level().isClientSide && this.container instanceof FreezerBlockEntity freezer)
        {
            freezer.spawnExperience(this.player);
        }
        this.removeCount = 0;
        Services.PLATFORM.fireItemSolidifyEvent(this.player, stack);
    }
}