...
public class ModBlocks
{
    ...
    public static final Supplier<Block> FREEZER_LIGHT = register("freezer_light",
            () -> new FreezerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion(), () -> ModBlocks.FRIDGE_LIGHT.get()));
    public static final Supplier<Block> FRIDGE_LIGHT = register("fridge_light",
            () -> new FridgeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion(), () -> ModBlocks.FREEZER_LIGHT.get()));
    public static final Supplier<Block> FREEZER_DARK = register("freezer_dark",
            () -> new FreezerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion(), () -> ModBlocks.FRIDGE_DARK.get()));
    public static final Supplier<Block> FRIDGE_DARK = register("fridge_dark",
            () -> new FridgeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion(), () -> ModBlocks.FREEZER_DARK.get()));
}