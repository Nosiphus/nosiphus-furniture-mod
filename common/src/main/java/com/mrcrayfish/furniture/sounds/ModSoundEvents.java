...
public class ModSoundEvents {
    ...
    private static Supplier<SoundEvent> register(String name) {
        return Services.REGISTRY.registerSoundEvent(name, () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MrCrayFishFurnitureMod.MOD_ID, name)));
    }
