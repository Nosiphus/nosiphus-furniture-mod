...
{
    private static final ResourceLocation FREEZER_GUI_TEXTURES = ResourceLocation.fromNamespaceAndPath(MrCrayFishFurnitureMod.MOD_ID, "textures/gui/container/freezer.png");
