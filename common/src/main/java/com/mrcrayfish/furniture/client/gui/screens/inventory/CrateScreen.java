...
{
    private static final ResourceLocation GUI_TEXTURE = new ResourceLocation(MrCrayFishFurnitureMod.MOD_ID, "textures/gui/container/crate.png");
    ...
    protected void init()
    {
        ...
        this.button = this.addRenderableWidget(new IconButton(this.leftPos + this.imageWidth + 2, this.topPos + 17, button -> {
            Services.NETWORK.sendToServer(new C2SMessageLockCrate());
        }, ICONS_TEXTURE, 0, 0));
