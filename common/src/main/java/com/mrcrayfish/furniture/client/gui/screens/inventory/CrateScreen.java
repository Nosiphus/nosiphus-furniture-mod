...
{
    private static final ResourceLocation GUI_TEXTURE = ResourceLocation.fromNamespaceAndPath(MrCrayFishFurnitureMod.MOD_ID, "textures/gui/container/crate.png");
    ...
    protected void init()
    {
        ...
        this.button = this.addRenderableWidget(new IconButton(this.leftPos + this.imageWidth + 2, this.topPos + 17, button -> {
            Services.NETWORK.sendToServer(new ServerboundLockCrate());
        }, ICONS_TEXTURE, 0, 0));
