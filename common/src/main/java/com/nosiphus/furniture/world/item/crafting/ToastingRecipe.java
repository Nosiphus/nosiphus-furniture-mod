...
{
    public ToastingRecipe(ResourceLocation id, String group, CookingBookCategory category, Ingredient ingredient, ItemStack result, float experience, int cookingTime)
    {
        super(ModRecipeTypes.TOASTING.get(), id, group, category, ingredient, result, experience, cookingTime);
    }
