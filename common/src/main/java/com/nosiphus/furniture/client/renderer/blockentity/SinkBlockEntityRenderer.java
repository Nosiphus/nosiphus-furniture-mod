...
public class SinkBlockEntityRenderer implements BlockEntityRenderer<SinkBlockEntity> {
    ...
    @Override
    public void render(SinkBlockEntity tileEntity, float partialTicks, PoseStack poseStack, MultiBufferSource source, int light, int overlay) {
        ...
        this.drawFluid(tileEntity, poseStack, source, 2.0F / 16.0F, 12.0F / 16.0F, 2.0F / 16.0F, 12.0F / 16.0F, 3.0F / 16.0F, 12.0F / 16.0F, light, overlay);

        poseStack.popPose();
    }

    private void drawFluid(SinkBlockEntity te, PoseStack poseStack, MultiBufferSource source, float x, float y, float z, float width, float height, float depth, int light, int overlay) {
        ...
        float currentHeight = height * fillRatio;
