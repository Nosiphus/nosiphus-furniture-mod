...
public class ToiletBlockEntityRenderer implements BlockEntityRenderer<ToiletBlockEntity> {
    ...
    public void render(ToiletBlockEntity tileEntity, float partialTicks, PoseStack poseStack, MultiBufferSource source, int light, int overlay) {
        ...
        this.drawFluid(tileEntity, poseStack, source, 4.0F / 16.0F, 6.4F / 16.0F, 3.2F / 16.0F, 8.0F / 16.0F, 2.8F / 16.0F, 8.0F / 16.0F, light, overlay);

        poseStack.popPose();
    }

    private void drawFluid(ToiletBlockEntity te, PoseStack poseStack, MultiBufferSource source, float x, float y, float z, float width, float height, float depth, int light, int overlay) {
