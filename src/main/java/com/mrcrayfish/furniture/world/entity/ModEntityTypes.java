package com.mrcrayfish.furniture.world.entity;
...
public class ModEntityTypes {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(Registries.ENTITY_TYPE, "cfm");
