...
import com.mrcrayfish.furniture.world.inventory.slot.FreezerFuelSlot;
import com.mrcrayfish.furniture.world.inventory.slot.FreezerResultSlot;
...
public class FreezerMenu extends AbstractContainerMenu
{
    ...
    {
        super(ModMenuTypes.FREEZER.get(), windowId);
    ...
    private boolean isIngredient(ItemStack stack)
    {
        return this.level.getRecipeManager()
                .getRecipeFor(ModRecipeTypes.FREEZER_SOLIDIFY.get(), new SingleRecipeInput(stack), this.level)
                .isPresent();
    }
