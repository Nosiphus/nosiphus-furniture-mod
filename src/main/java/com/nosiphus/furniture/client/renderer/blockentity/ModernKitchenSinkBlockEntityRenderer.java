...
public class ModernKitchenSinkBlockEntityRenderer implements BlockEntityRenderer<ModernKitchenSinkBlockEntity>
{
    ...
    public ModernKitchenSinkBlockEntityRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(ModernKitchenSinkBlockEntity tileEntity, float partialTicks, PoseStack poseStack, MultiBufferSource source, int light, int overlay)
    {
        poseStack.pushPose();
    ...
    private void drawFluid(ModernKitchenSinkBlockEntity te, PoseStack poseStack, MultiBufferSource source, float x, float y, float z, float width, float height, float depth, int light)
    {
