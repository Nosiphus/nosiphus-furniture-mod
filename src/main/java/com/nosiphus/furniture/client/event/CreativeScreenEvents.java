...
public class CreativeScreenEvents
{
    ...
    public void onScreenInit(GuiScreenEvent.InitGuiEvent.Post event)
    {
        if(event.getGui() instanceof CreativeScreen)
        {
            ...
            if(screen.getSelectedTabIndex() == NosiphusFurnitureMod.GROUP.getIndex())
            {
    ...
    private void updateItems(CreativeScreen screen)
    {
        ...
        {
            item.fillItemGroup(NosiphusFurnitureMod.GROUP, newItems);
        }
    ...
    {
        final TagFilter GENERAL = new TagFilter(new ResourceLocation(Reference.MOD_ID, "general"), new ItemStack(ModBlocks.CHAIR_WHITE_MODERN.get()));
        final TagFilter STORAGE = new TagFilter(new ResourceLocation(Reference.MOD_ID, "storage"), new ItemStack(ModBlocks.CABINET_WHITE_MODERN.get()));
        final TagFilter BEDROOM = new TagFilter(new ResourceLocation(Reference.MOD_ID, "bedroom"), new ItemStack(ModBlocks.DESK_WHITE_MODERN.get()));
        final TagFilter KITCHEN = new TagFilter(new ResourceLocation(Reference.MOD_ID, "kitchen"), new ItemStack(ModBlocks.KITCHEN_COUNTER_WHITE_MODERN.get()));
        final TagFilter BATHROOM = new TagFilter(new ResourceLocation(Reference.MOD_ID, "bathroom"), new ItemStack(ModBlocks.TOILET_LIGHT.get()));
        TagFilter[] filters = new TagFilter[] {GENERAL, STORAGE, BEDROOM, KITCHEN, BATHROOM};

        ForgeRegistries.ITEMS.getValues().stream()
                .filter(item -> item.getGroup() == NosiphusFurnitureMod.GROUP)
