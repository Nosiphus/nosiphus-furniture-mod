 ...
 * Author: MrCrayfish
 */
public class ModernDeskBlock extends FurnitureHorizontalWaterloggedBlock
{
    ...
    private boolean isDesk(IWorld world, BlockPos source, Direction checkDirection, Direction tableDirection)
    {
        ...
        return state.getBlock() instanceof ModernDeskBlock && ((ModernDeskBlock) state.getBlock()).materialType == materialType && state.get(DIRECTION) == tableDirection;
    }
