...
public class ForgeFluidHelper implements IFluidHandler {

    private static final Map<FluidHandlerSyncedBlockEntity, ForgeFluidHelper> CACHE = new WeakHashMap<>();

    public static ForgeFluidHelper of(FluidHandlerSyncedBlockEntity blockEntity) {
        return CACHE.computeIfAbsent(blockEntity, ForgeFluidHelper::new);
    }

    private final FluidHandlerSyncedBlockEntity blockEntity;

    public ForgeFluidHelper(FluidHandlerSyncedBlockEntity blockEntity) {
