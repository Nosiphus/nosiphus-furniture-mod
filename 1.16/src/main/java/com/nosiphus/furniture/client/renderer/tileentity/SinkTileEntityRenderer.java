package com.nosiphus.furniture.client.renderer.tileentity;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mrcrayfish.furniture.block.FurnitureHorizontalBlock;
import com.nosiphus.furniture.tileentity.SinkTileEntity;
 ...
 * Author: MrCrayfish
 */
public class SinkTileEntityRenderer extends TileEntityRenderer<SinkTileEntity>
{
    public SinkTileEntityRenderer(TileEntityRendererDispatcher dispatcher)
    {
        super(dispatcher);
    }

    @Override
    public void render(SinkTileEntity tileEntity, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, int light, int i1)
    {
        matrixStack.push();
        ...
        matrixStack.translate(-0.5, -0.5, -0.5);
        this.drawFluid(tileEntity, matrixStack, renderTypeBuffer, 2F * 0.0625F, 12F * 0.0625F, 2F * 0.0625F, 10F * 0.0625F, 3F * 0.0625F, 12F * 0.0625F, light);
        matrixStack.pop();
    }

    private void drawFluid(SinkTileEntity te, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, float x, float y, float z, float width, float height, float depth, int light)
    {
